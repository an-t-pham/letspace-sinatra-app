...
peter = Tenant.create(name: "Peter Pan", profile: "A trustworthy tenant", image_url: "https://s3.ap-southeast-1.amazonaws.com/images.asianage.com/images/aa-Cover-5neknqovdb6hesko5h0c8jbr36-20180130131031.Medi.jpeg")
wendy = Tenant.create(name: "Wendy Darling", profile: "A clean tenant", image_url: "https://images.unsplash.com/photo-1494790108377-be9c29b29330?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&w=1000&q=80")
hook = Tenant.create(name: "James Hook", profile: "An annoying tenant", image_url: "https://vignette.wikia.nocookie.net/disney/images/0/0b/Profile_-_Captain_Hook.jpeg/revision/latest?cb=20190312022618")
